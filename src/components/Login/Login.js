...
const Login = () => {
    const {handleLogin, handleGoogleSignIn ,handleEmail, handlePassword, resetPassword , error } = useFirebase()
    return (
            <div>
            <div className='my-5 mx-auto w-50'>
                <form onSubmit = {handleLogin} >
                    ...
                    <div>
                        ...
                        <Button onClick = {handleGoogleSignIn }  variant="warning" className='me-3 mt-2'><i className="fab fa-google text-white fs-5 px-4 "></i></Button>
